...
<body>
	...
	<div id="logintext">Login to KTX Railways!</div><br/><br/>
	<table>
  ...
  <a href="login_admin.php"  style="background-color:#ffffa0">Admin Login</a>
</div>
	<div style="text-align:center">    
  <a href="changepw.php"  style="background-color:#ffffa0">Forgot Password</a>
</div>
